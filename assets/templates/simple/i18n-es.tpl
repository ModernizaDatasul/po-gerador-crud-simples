export const {camelCase}Es = {
    {camelCase}: '{camelCase}',

    addNew{pascalCase}: 'Nuevo{pascalCase}',
    edit{pascalCase}: 'Editar{pascalCase}',
    ...
    cancelText: ''¿Estás seguro de que desea cancelar sus cambios? Todos los datos no guardados se perder�n.',
